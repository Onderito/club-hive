  ...
  return (
    <>
      <div className="shadow-sm shadow-[#585BFF] rounded-xl pt-4 pb-14 mt-8 bg-[#26263B]/45 ">
        ...
        <button className="absolute text-white text-[12px] md:text-[14px] lg:text-[16px] font-montserrat font-bold text-lg mt-4 -rotate-6 bg-[#181818] shadow-inner-color rounded-lg py-1 px-6 right-[120px] bottom-3 ">
          Send invitation
        </button>
      </div>
    </>
